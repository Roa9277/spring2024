...
<script type="text/javascript">
	...
	$(function() {
		...
		$('button').on("click",
			function(e) {
				e.preventDefault();  // 페이지 이동을 할 때 refresh 동작을 방지
                	...
                	<div class="panel panel-default">
	                		...
	                		<div class="panel-body">
	                			<form role="form" action="/board/modify" method="post">
		                			...
		                			<div class="form-group">
		                				<label>Reg Date</label> <input class="form-control" name="regDate" readonly="readonly"
		                					value='<fmt:formatDate pattern = "yyyy/MM/dd" value="${board.regdate }"/>' >
		                			</div>
		                			<div class="form-group">
		                				<label>Update Date</label> <input class="form-control" name="updateDate" readonly="readonly"
